...
<div class="content-page">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <a href="add_expense_category.php" class="btn btn-md btn-dark btn-info waves-effect waves-light float-right">
                            <i class="fa fa-plus"></i> Add New Expense Category
                        </a>
                        </div>
                        <h4 class="page-title" style="letter-spacing: 2px;">Expense Category</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
    ...
    $(document).ready(function() {
        ...
        $('#edit_new_category').submit(function(e) {
            ...
            $.ajax({
                url: 'api_calls/expenses/edit-category.php',
                type: 'POST',
                data: formdata,
        ...
        $(document).on('click', '.edit-category', function(e) {
            ...
            $.ajax({
                url: 'api_calls/expenses/fetch-expense-details.php',
                type: 'POST',
    ...
    function readCategories() {
        ...
        if (check == 0) {
            $('#tickets-table').dataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': 'api_calls/expenses/fetch-edit-expense-category.php'
                },
                'columns': [{
        ...
        swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                            url: 'api_calls/expenses/delete-expense.php',
                            type: 'POST',
