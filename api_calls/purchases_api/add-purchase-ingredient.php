<?php
        ...
        $clean_input_name = ($_POST['name']);
        $get_purchase_id = ($_POST['purchase_id']);
        $get_names = $clean_input_name;
        ...
        for ($i=0; $i < $get_length_of_items ; $i++) { 
          ...
          $get_previous_quantity = mysqli_query($connectionString, "SELECT * FROM tbl_ingredients WHERE tbl_ingredient_id = '$get_name' LIMIT 1")or die(mysqli_error($connectionString));
