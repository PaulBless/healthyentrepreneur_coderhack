                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title" style="letter-spacing: 2px"> Sales Report</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                 <div class="card-box" style="border-top: 3px solid #14324d;">
                                    <h4 class="header-title mb-4 text-dark">Sales Report From : <?php echo date('d-M-Y',strtotime($get_from)).' to '.date('d-M-Y',strtotime($get_to)) ?></h4>
