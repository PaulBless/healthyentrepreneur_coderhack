                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                          ...
                                          <h4 class="page-title" style="letter-spacing: 2px;">Report : <span class="text-secondary">Purchases Products</span></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
...
<?php if(isset($_POST['btn_fetch_report'])){
    ...
    ?>
                        <div class="row">
                            <div class="col-12">
                                 <div class="card-box" style="border-top: 3px solid #14324d;">
                                    <h4 class="header-title mb-4 text-dark">Purchases Report From : <?php echo date('d-M-Y',strtotime($get_from)).' to '.date('d-M-Y',strtotime($get_to)) ?></h4>
        ...
        $get_each_purchase = mysqli_query($connectionString,"SELECT * from tbl_purchase join tbl_products on tbl_purchase.product_id = tbl_products.tbl_products_id WHERE `purchase_timestmap` > '$start_date' AND purchase_timestmap  < '$end_date'")or die(mysqli_error($connectionString));
        while($each_purchase = mysqli_fetch_array($get_each_purchase)){
          
            $product_name = $each_purchase['product_name'];
            ...
            $product_timestamp = date('d-M-Y',strtotime($each_purchase['purchase_timestmap']));
 ...
 <script type='text/javascript'>
    ...
    var exportTitle = 'Sales Report From : '+start_at+' to '+ends_at;
