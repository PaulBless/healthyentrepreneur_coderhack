...
<main class="col-md-6 bg-white mt-1" style="border: 1px solid #56c2d6; background: -webkit-linear-gradient(top, #48c6ef, #1a82f7); background: -moz-linear-gradient(top, #48c6ef, #1a82f7);">
