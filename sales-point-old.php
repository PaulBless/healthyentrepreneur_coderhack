            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="ml-auto page-title">
                            ...
                            <button class="btn btn-md btn-primary mr-0 order-food" id="order_food"><i class="mdi mdi-food" ></i> Order Food </button>
                            ...
                            <table class="table  table-bordered table-hover " id="invoiceItem" width="100">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="13%"><select class="form-control quantity_type" name="quantity_type[]" id="quantity_type_1"><option value='1'>Pcs</option> <option value='2'>Box</option> </select> </td>
                                        ...
                                        <td width="13%"><input type="number" min="0" required="required" name="quantity[]" id="quantity_1" class="form-control quantity text-center" autocomplete="off"></td>
            ...
            <div class="card d-flex align-items-center justify-content-center" style="border-bottom: 3px solid #14324d;">
                <div class="card-body ">
                    <div class="form-group">
                        ...
                        <button class="btn btn-lg btn-outline-primary btn-submit font-weight-bold text-uppercase mr-1" id="1"><i class="fa fa-save mr-1"></i>Save Only</button>
                        <button class="btn btn-lg btn-success btn-submit font-weight-bold text-uppercase ml-2" id="2"><i class="fa fa-print mr-1"></i>Save + Print</button>
...
$(document).ready(function() {
    ...
    $(document).on('submit', '#pos-form', function(e) {
        ...
        var formdata = $(this).serialize();
        $.ajax({
            url: 'api_calls/sales_api/record-sales.php',
            type: 'POST',
            data: formdata,
            success: function(res) {
                if (res === 'success') {
